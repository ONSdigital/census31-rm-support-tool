...
run-dev-api: build
	docker run -e spring_profiles_active=docker --network=censusrmdockerdev_default --link ons-postgres:postgres -p 9999:9999 europe-west2-docker.pkg.dev/c31-rm-ci-prod/rm-docker-snapshot/census31-rm-support-tool:latest
